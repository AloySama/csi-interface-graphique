  ...
  <div class="app">
    <header>
      ...
      <div class="order" id="buttons">
        ...
        <button id="modify" class="btn blue" :disabled="json==null" @click="bool.Modify = true; bool.ChooseFile = false; disabledButtons('modify', 'old_edit');">Modifier éléments</button>
        <button class="btn purple" @click="DownloadFile" :disabled="json==null" :title="message['save']">Enregistrer</button>
      </div>
    </header>
  </div>
